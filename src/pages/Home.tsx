      ...
      <section className="relative h-[85vh] sm:h-[90vh] md:h-[100vh] overflow-hidden">
        ...
        <div className="relative container mx-auto flex h-full items-center justify-center px-4 text-center">
          <div className="max-w-4xl">
            <h1 className="mb-4 text-2xl font-display tracking-wide text-white uppercase sm:text-3xl sm:mb-6 md:text-4xl lg:text-5xl xl:text-6xl">
              These Outfits Will Do The Talking
            </h1>
            <p className="mb-6 text-[10px] font-medium uppercase tracking-[0.15em] text-white/90 sm:text-xs sm:tracking-[0.2em] sm:mb-8">
              Designed for every mood, every moment, made in UAE.
            </p>
            <Link 
              to="/products"
              className="inline-block border border-white bg-transparent px-6 py-2.5 text-[10px] font-medium tracking-[0.1em] uppercase text-white transition-colors hover:bg-white hover:text-foreground sm:px-8 sm:py-3 sm:text-xs"
            >
              SHOP NOW
            </Link>
          </div>
